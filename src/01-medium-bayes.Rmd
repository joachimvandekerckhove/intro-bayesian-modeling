...
- $K_*$ is the sum of everything else over values of $P_R$
...
## The Lady Tasting Wine (RRRRRW)
Shaping ones posterior: $p(\theta|x) = K p(\theta)p(x|\theta)$
...
## The Lady Tasting Wine (RRRRRW)
Excercise: plot these in R, using ${\color{blue}\#R=5}$, ${\color{blue}\#W=1}$
...
S_w & \times {\color{red}K_w (1.01 - P_R)(P_R - 0.49)} \\
    & \times {\color{blue}C (1 - P_R)^{\#W} P_R^{\#R}} \times {\color{gray}C (1 - P_R)^{\#W_2} P_R^{\#R_2}}
\end{aligned}$$
- ... which is equal to:
$$\begin{aligned}
